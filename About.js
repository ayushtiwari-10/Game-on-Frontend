      ...
      <section className="why-it-works">
        ...
        <div className="features">
          ...
          <div className="feature">
            ...
            <p>
              Teachers can identify gaps in their students' understanding, tailor instruction, and meet the needs of
              every student.
            </p>
          </div>
        </div>
      ...
      <section className="success-stories">
        ...
        <div className="story">
          <div className="story-content">
            ...
            <p>
              Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam, nisi ut al Ut
        ...
        <div className="team-carousel">
          ...
          <div className="team-members">
            {teamMembers.map((member, index) => (
              <div key={index} className={`team-member ${index === currentSlide ? "active" : ""}`}>
