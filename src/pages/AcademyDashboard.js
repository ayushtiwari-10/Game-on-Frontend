...
const faqs = [
  ...
  {
    id: 5,
    question: "Is there a cost to use the create vacancy, and what features are free?",
    ...
    <div className="academy-dashboard">
      ...
      <header className="dashboard-header">
        <nav className="nav-container">
          ...
          <div className="nav-links">
            ...
            <Link to="/create-tournament">Host Tournament</Link>
          ...
          <div className="user-section">
            ...
            <button className="icon-button profile" onClick={() => navigate("/academy-profile")}></button>
          </div>
        </nav>
      </header>
      ...
      <section className="welcome-section">
        <div className="platform-info">
          <span className="platform-tag">Your #1 Platform for Skill Sharing</span>
        </div>
      ...
      <section className="categories-section">
        <div className="categories-list">
          {sportCategories.map((sport) => (
            <button
              key={sport.name}
              className={`category-btn ${selectedCategory === sport.name ? "active" : ""}`}
        ...
        <div className="faq-grid">
          {faqs.map((faq) => (
            <div
              ...
              onClick={() => setExpandedFaq(faq.id === expandedFaq ? null : faq.id)}
            >
